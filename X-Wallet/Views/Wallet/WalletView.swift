                ...
                ScrollView {
                    VStack {
                        ...
                        HStack(spacing: 12) {
                            ...
                            NavigationLink {
                                ...
                                TextWithImage(
                                    ...
                                    image: Image("receive"),
                                    imageForegroundColor: Colors.blueWhite,
                                    verticalPadding: 8, cornerRadius: 30
                                )
                            }
                        ...
                        if search {
                            CustomTextField(
                                text: $searchText,
                                leadingImageName: "search",
                                leadingImageColor: Colors.blue70White70,
                                trailingImageName: "close",
                                trailingImageColor: Colors.blue70White70,
                                placeholderText: data.strings.searchCoins) {
