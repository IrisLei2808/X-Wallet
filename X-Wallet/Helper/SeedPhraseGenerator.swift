...
struct SeedPhraseGenerator {
    private init() {}
    static let shared = SeedPhraseGenerator()
    func generate(length: Int = 12) -> String {
        guard length > 0 else { return "" }
        var phrase = ""
        for _ in 1...length {
            let randomIndex = Int.random(in: 0..<dictionary.count)
            phrase += dictionary[randomIndex] + " "
        }
        // Remove the last space
        phrase.removeLast()
        return phrase
    }
    private var defaultSeedPhrase: String {
        "thunder three twin abandon barely recipe hen polar garbage riot chair ghost"
    }
    private var dictionary = [
        "abandon", "ability", "able", "about", "above",
        "absent", "absorb", "abstract", "absurd", "abuse", 
        "access", "accident", "account", "accuse", "achieve",
        "acid", "acoustic", "acquire", "across", "act", "action",
        ...
        "blood", "blossom", "blouse", "blue", "blur", "blush", "board",
        "boat", "body", "boil", "bomb", "bone", "bonus", "book", "boost",
        "border", "boring", "borrow", "boss", "bottom", "bounce", "box",
        "boy", "bracket", "brain", "brand", "brass", "brave", "bread",
        ...
        "disagree", "discover", "disease", "dish", "dismiss", "disorder", "display",
        ...
        "fruit", "fuel", "fun", "funny",
        "furnace", "fury", "future", "gadget", "gain", "galaxy", "gallery", "game", "gap",
        ...
        "kid", "kidney", "kind", "kingdom", "kiss", "kit", "kitchen", "kite", "kitten",
        ...
        "nice", "night", "noble", "noise", "nominee", "noodle", "normal", "north", "nose",
