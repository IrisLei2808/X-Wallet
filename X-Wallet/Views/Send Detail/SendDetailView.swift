        ...
        ZStack {
            VStack {
                ...
                Image("btc")
                    ...
                    CustomText(
                        name: data.strings.availableBalance,
                    ...
                    HStack(spacing: 0) {
                        CustomText(
                            name: "120,3567",
                            textColor: Colors.blueBrown,
                            alignment: .trailing,
                            font: Fonts.boldFont26,
                            maxWidth: false,
                            setGradient: colorScheme == .dark
                        )
                        CustomText(
                            name: "TOMB",
                            textColor: Colors.blueBrown,
                            ...
                            Color.clear
                                .onAppear {
                                    DispatchQueue.main.asyncAfter(deadline: .now()+0.2) {
                                        let globalYOrigin = geometry.frame(in: CoordinateSpace.global).origin.y
                                        sheetOffset = UIScreen.main.bounds.height - globalYOrigin - 36.0
                                    }
                                }
                        }
                    )
                        ...
                        VStack {
                            VStack(spacing: 24) {
                                CustomTextFieldWithTitle(
                                    text: $address,
                                    trailingImageName: "personAndScan",
                                    title: data.strings.recipientAddress
                                ) {
                            ...
                            VStack(spacing: 0) {
                                CustomTextFieldWithTitle(
                                    text: $amount,
                                    leadingImageName: "wallet",
                                    trailingString: "TOMB",
                                    title: data.strings.amount
                                )
                                CustomText(
                                    name: "≈$0.83",
                            ...
                            HStack(spacing: 14) {
                                ...
                                CustomText(
                                    name: data.strings.saveRecipient,
                                    textColor: Colors.blueWhite,
                                    font: Fonts.mediumFont14
                                )
                            }
