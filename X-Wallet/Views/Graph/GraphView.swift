...
struct GraphView: View {
    ...
    @State var sampleAnalytics: [GraphData] = []
                ...
                VStack {
                    ...
                    HStack(spacing: 12) {
                        NavigationLink {
                            ...
                            TextWithImage(
                                todayChangedAmount: data.strings.send,
                        ...
                        NavigationLink {
                            ...
                            TextWithImage(
                                todayChangedAmount: data.strings.receive,
                                todayChangedPercentage: "",
                                textBackgroundColor: Colors.brown8Brown5,
                                textForegroundColor: Colors.blueWhite,
                                image: Image("receive"),
                        ...
                        NavigationLink {
                            ...
                            TextWithImage(
                                todayChangedAmount: data.strings.swap,
                                todayChangedPercentage: "",
                                textBackgroundColor: Colors.brown8Brown5,
                                textForegroundColor: Colors.blueWhite,
                                image: Image("swap"), verticalPadding: 8, cornerRadius: 30
                            )
                        }
                    }
    ...
    private func annotationView() -> some View {
        VStack(alignment: .leading, spacing: 0) {
            let dateString = dateFormatter.string(from: currentActiveItem?.hour ?? Date())
            let dateComponents = dateString.components(separatedBy: " ")
            let datePart = dateComponents.first ?? "04/08/2023"
            let timePart = dateComponents.last ?? "06:00"
...
//#if os(iOS)
//        NavigationView {
//            GraphView().environmentObject(XWalletData())
//        }
//#else
