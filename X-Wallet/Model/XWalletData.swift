...
class XWalletData: ObservableObject {
...
extension XWalletData {
    struct Preview {
        ...
        static var notification: Notification {
            Notification(
                id: "123",
                title: "Received crypto from others",
                description: "You have received a payment of 100 USDT at 2023-07-01 14:28:33 (UTC). You can check your transaction details in Binance Pay homepage via Wallets-Funding-Pay", 
                date: "2023-08-21 06:03:05 +0000",
                isRead: true)
        }
        ...
        static var tokenContact: TokenContact {
            TokenContact(
                id: "3f843464-4258-11ee-be56-0242ac120002",
                name: "Bitcoin",
                imageName: "bitcoin",
